      ...
      <Space orientation="vertical" style={{ width: '100%' }} size={16}>
        ...
        {result && (
          <div style={{ background: '#f8fafc', borderRadius: 8, padding: 16 }}>
            ...
            <Row gutter={16}>
              <Col span={8}><Statistic title="成功" value={result.success} styles={{ content: { color: '#10b981', fontWeight: 700 } }} /></Col>
              <Col span={8}><Statistic title="失败" value={result.fail} styles={{ content: { color: '#ef4444', fontWeight: 700 } }} /></Col>
              <Col span={8}><Statistic title="跳过" value={result.skip} styles={{ content: { color: '#f59e0b', fontWeight: 700 } }} /></Col>
            </Row>
            {result.fail > 0 && (
