...
async def weekly_list(project_id: int, month: str = None, db: AsyncSession = Depends(get_db)):
...
async def weekly_save(project_id: int, dto: dict = Body(...), db: AsyncSession = Depends(get_db)):
    month = dto.get("periodMonth"); week = dto.get("weekNumber")
...
async def milestone_list(project_id: int, db: AsyncSession = Depends(get_db)):
...
async def milestone_save(project_id: int, items: list = Body(...), db: AsyncSession = Depends(get_db)):
...
async def team_list(project_id: int, db: AsyncSession = Depends(get_db)):
...
async def team_save(project_id: int, items: list = Body(...), db: AsyncSession = Depends(get_db)):
...
async def wbs_list(project_id: int, db: AsyncSession = Depends(get_db)):
...
async def wbs_save(project_id: int, items: list = Body(...), db: AsyncSession = Depends(get_db)):
...
async def change_list(project_id: int, db: AsyncSession = Depends(get_db)):
...
async def change_create(project_id: int, dto: dict = Body(...), db: AsyncSession = Depends(get_db)):
